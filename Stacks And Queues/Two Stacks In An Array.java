  ...
  public static class TwoStack {
    ...
    void push1(int val) {
      ...
      if(size1()+size2()==data.length)
      {
          ...
          tos1++;
          data[tos1]=val;
        //   System.out.println(tos1+"----"+data[tos1]);
      }
    }
    ...
    void push2(int val) {
      ...
      if(size1()+size2()==data.length)
      {
          ...
          tos2--;
          data[tos2]=val;
        //   System.out.println(tos2+"-----"+data[tos2]);
      }
    }
    ...
    int pop1() {
      ...
      tos1--;
    //   System.out.println(tos1+"---"+data[tos1+1]);
      return data[tos1+1];
    }

    int pop2() {
      // write your code here
      if(data.length-tos2==0)
      {
          System.out.println("Stack underflow");
          return -1;
      }
      tos2++;
    //   System.out.println(tos2+"---"+data[tos2-1]);
      return data[tos2-1];
    }
